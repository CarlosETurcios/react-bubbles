...
a token is givin to a user once they enter their username and password to enter a recource for a period of time .

- [ ] What steps can you take in your web apps to keep your data secure?

set up a private route and use axiosWithAuthintacation .

- [ ] Describe how web servers work.

it uses a sofwate program to execute code . when we go on the internet we navigate to a web site we access the server .
the web browser request the web server and the web sever serves the webpage .

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

we would use the put in up date to interface with apis/servers .
